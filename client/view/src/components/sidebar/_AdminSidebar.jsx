import { ArrowLeftFromLine, Bell, LayoutDashboard, School, SquareCheckBig, User, Users, Newspaper, LayoutDashboardIcon } from 'lucide-react';
const AdminSideBar = [
  ...
  { name: 'Quản lý tin tức', href: '/feed-management', current: false, icon: <Newspaper size={20} /> },
  { name: 'Thống kê dữ liệu', href: '/dashboard-management', current: false, icon: <LayoutDashboardIcon size={20} /> },
